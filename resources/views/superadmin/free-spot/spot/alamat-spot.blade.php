...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" placeholder="Tuliskan alamat spot secara lengkap." name="pr_addr" required style="resize: none; height: 100px;"></textarea>
        </div>
    </div>
</div>