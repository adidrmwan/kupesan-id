      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Partner <span class='badge' style='background-color:orange;'>Free Spot</span></h3>
          </div>
          <div class="box-body">
            <div class="btn-group">
                <a href="{{route('add.free-spot')}}">
                    <button type="button" class="btn btn-primary"><i class='fa fa-plus'></i>&nbsp;&nbsp;&nbsp;Add Partner</button>
                </a>
            </div>
            <hr>
