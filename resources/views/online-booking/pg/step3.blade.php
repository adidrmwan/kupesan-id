      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <h5 class="text-center"><b>{{$partner->pr_addr}}, {{$partner->pr_kel}}, @if(!empty($kecamatan)){{$kecamatan->name}}@endif, @if(!empty($kota)){{$kota->name}}@endif, @if(!empty($provinsi)){{$provinsi->name}}@endif, {{$partner->pr_postal_code}}</b></h5>
            <h6 class="alert alert-warning text-center">Klik pilihan dibawah ini, <br>jika pesanan diambil di lokasi Partner-KU
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body"> 
        ...
        <div class="row">
          <div class="col-md-12">
            <h6 class="alert alert-warning text-center">Klik pilihan dibawah ini, <br>jika pesanan dikirim ke lokasi Anda
            <div class="radio text-center" >
