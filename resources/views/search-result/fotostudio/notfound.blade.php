            ...
            <div class="row">     
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group" >
                                                <select  class="form-control" name="theme">
                                                    <option selected value="All_theme">Semua</option>
                                                    @foreach($listtema as $value)
                                                    <option value="{{$value->tag_id}}">{{$value->tag_title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>             
                                        </div>    
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 content-side">
                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <h3><b><span style="color: #EA410C;">Semua </span> Spot di <span style="color: #EA410C;">Kota Surabaya</span></b></h3>
                        @else
                        <h3><b><span style="color: #EA410C;">{{$tema->type_name}}</span> di <span style="color: #EA410C;">Kota Surabaya</span></b></h3> 
                        @endif
                        @if(Auth::check())
