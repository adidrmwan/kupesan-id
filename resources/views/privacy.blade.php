                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 content-side">
                            <div class="faq-block" style="text-align: justify;">
                                ...
                                <div>
                                    <p>Kebijakan privasi yang tertera merupakan gambaran atau dasar yang digunakan untuk menentukan definisi, arahan dan batasan atas segala informasi dan data pribadi yang disertakan oleh Pengguna ataupun yang diperoleh dari Pengguna pada saat mengakses situs web atau berafiliasi dengan KUPESAN.ID.<br><br>
                                    Seluruh Pengguna ataupun pihak yang berafiliasi dengan KUPESAN.ID diharapkan untuk membaca, memahami, dan mengerti segala bentuk kebijakan privasi yang tertera pada laman situs web KUPESAN.ID.<br><br>
                                    Kebijakan privasi mencakup hal-hal sebagai berikut:</p> 
                                </div>
