        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info">
                    <p>{{$partner->pr_kel}}, @if(!empty($partner_kec)){{$partner_kec->name}}@endif, @if(!empty($partner_kota)){{$partner_kota->name}}@endif, @if(!empty($partner_prov)){{$partner_prov->name}}@endif, {{$partner->pr_postal_code}}</p>
                </div>
            </div>
        </div>
        @endif
