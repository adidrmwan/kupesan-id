                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <div class="row">
                                        <div class="col-lg-5 col-xs-4">
                                            <div class="form-group">
                                              <label>Durasi Paket<small><b style="color:red;"> * </b></small></label>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Kapasitas Spot<small><b style="color:red;"> * </b></small></label>
                                            <input type="number" min="1" max="100" class="form-control" placeholder="Jumlah Kapasitas" required="" name="pkg_capacity">
                                            <div class="invalid-feedback">Wajib diisi.</div>
                                        </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Fotografer<small><b style="color:red;"> * </b></small></label>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Print Size<small><b style="color:red;"> * </b></small></label>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Edited Photo<small><b style="color:red;"> * </b></small></label>
                                            <input type="number" min="0" max="1000" class="form-control" placeholder="Jumlah Foto" required="" name="pkg_edited_photo">
                                            <div class="invalid-feedback">Wajib diisi.</div>
                                        </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        ...
                                        <select id="tags" class="form-control" name="tag[]" required=""></select>
                                            <div class="invalid-feedback">Wajib diisi.</div>
                                      </div>
                                    </div>
                                  </div>
