                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <table class="table table-sm table-hover">
                                            ...
                                            @if(!empty($data->booking_user_email))
                                            <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="{{ route('order.completed') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    ...
                                    @if($flag_date == '0')
                                    <small>* Anda dapat menyetujui pesanan ini pada tanggal <b>{{ date('d F Y', strtotime($data->booking_start_date)) }}</b>.</small>
                                    <button type="submit" class="btn btn-block pull-right" onclick="return confirm('Are you sure want to complete this booking?')" disabled="">Order Completed</button>
                                    @elseif($flag_date == '1')
